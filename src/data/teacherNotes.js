    ...
    slides: [
      {
        ...
        narrative: "Let the first layer play slowly and narrate it: 'Every word looks at the other words. Then the thinking part asks questions — spelling, grammar, facts, meaning.' When it pauses, take the vote: 1 more? 3? 12? 93? 3,200? Reveal: today's big models use roughly 50–100 layers; our example does it 93 more times. Then press 'Run the other 93 layers' and let the questions evolve from 'Is this spelled right?' (early) to 'Which word fits best?' (late).",
